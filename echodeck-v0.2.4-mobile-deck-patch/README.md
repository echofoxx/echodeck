# EchoDeck v0.2.4 — Adaptive Panel Fit
...
## v0.2.4 adaptive panel fit update

EchoDeck v0.2.4 focuses on preventing overflow in the Now Playing screen. It adds adaptive panel sizing, responsive typography, dynamic title fitting, and stronger clipping rules so metadata no longer bleeds into the Queue panel when the desktop window is narrow or short.
...
## EchoDeck v0.2.4 — Analog Cream Theme + iOS Roadmap
...
The iOS app is not packaged in this release. v0.2.4 prepares the shared UI/theme layer so a future Capacitor shell can reuse the EchoDeck player experience.

## v0.2.4 Mobile Deck Modes

# EchoDeck v0.1.2 — Local Desktop Music App MVP

EchoDeck is a local-first desktop music player prototype for **Windows 11 and macOS**. It focuses on local music playback, playlist/queue management, EQ, visualizations, crossfade, modern/vintage themes, and source-aware streaming embeds.
